...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2015 at 03:14 PM
...
--
-- Table structure for table `ra2_assets`
--

CREATE TABLE IF NOT EXISTS `ra2_assets` (
...
--
-- Dumping data for table `ra2_assets`
--

INSERT INTO `ra2_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(23, 1, 332, 333, 1, 'com_templates', 'com_templates', '{"core.admin":{"7":1},"core.options":[],"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
--
-- Table structure for table `ra2_associations`
--

CREATE TABLE IF NOT EXISTS `ra2_associations` (
...
--
-- Table structure for table `ra2_banners`
--

CREATE TABLE IF NOT EXISTS `ra2_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ra2_banner_clients`
--

CREATE TABLE IF NOT EXISTS `ra2_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `ra2_banner_clients`
--

INSERT INTO `ra2_banner_clients` (`id`, `name`, `contact`, `email`, `extrainfo`, `state`, `checked_out`, `checked_out_time`, `metakey`, `own_prefix`, `metakey_prefix`, `purchase_type`, `track_clicks`, `track_impressions`) VALUES
...
--
-- Table structure for table `ra2_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `ra2_banner_tracks` (
...
--
-- Table structure for table `ra2_categories`
--

CREATE TABLE IF NOT EXISTS `ra2_categories` (
  `id` int(11) NOT NULL,
...
(34, 59, 16, 62, 63, 2, 'sample-data-contact/park-site', 'com_contact', 'Park Site', 'park-site', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, 'en-GB', 1),
(35, 60, 16, 64, 121, 2, 'sample-data-contact/shop-site', 'com_contact', 'Shop Site', 'shop-site', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(36, 61, 35, 65, 66, 3, 'sample-data-contact/shop-site/staff', 'com_contact', 'Staff', 'staff', '', '<p>Please feel free to contact our staff at any time should you need assistance.</p>', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(37, 62, 35, 67, 120, 3, 'sample-data-contact/shop-site/fruit-encyclopedia', 'com_contact', 'Fruit Encyclopedia', 'fruit-encyclopedia', '', '<p> </p><p>Our directory of information about different kinds of fruit.</p><p>We love fruit and want the world to know more about all of its many varieties.</p><p>Although it is small now, we work on it whenever we have a chance.</p><p>All of the images can be found in <a href="http://commons.wikimedia.org/wiki/Main_Page">Wikimedia Commons</a>.</p><p><img src="images/sampledata/fruitshop/apple.jpg" border="0" alt="Apples" title="Apples" /></p><p><em>This encyclopedia is implemented using the contact component, each fruit a separate contact and a category for each letter. A CSS style is used to create the horizontal layout of the alphabet headings. </em></p><p><em>If you wanted to, you could allow some users (such as your growers) to have access to just this category in the contact component and let them help you to create new content for the encyclopedia.</em></p><p> </p>', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(38, 63, 37, 68, 69, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/a', 'com_contact', 'A', 'a', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(39, 64, 37, 70, 71, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/b', 'com_contact', 'B', 'b', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(40, 65, 37, 72, 73, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/c', 'com_contact', 'C', 'c', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(41, 66, 37, 74, 75, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/d', 'com_contact', 'D', 'd', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(42, 67, 37, 76, 77, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/e', 'com_contact', 'E', 'e', '', '', 0, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(43, 68, 37, 78, 79, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/f', 'com_contact', 'F', 'f', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(44, 69, 37, 80, 81, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/g', 'com_contact', 'G', 'g', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(45, 70, 37, 82, 83, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/h', 'com_contact', 'H', 'h', '', '', 0, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(46, 71, 37, 84, 85, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/i', 'com_contact', 'I', 'i', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(47, 72, 37, 86, 87, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/j', 'com_contact', 'J', 'j', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(48, 73, 37, 88, 89, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/k', 'com_contact', 'K', 'k', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(49, 74, 37, 90, 91, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/l', 'com_contact', 'L', 'l', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(50, 75, 37, 92, 93, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/m', 'com_contact', 'M', 'm', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(51, 76, 37, 94, 95, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/n', 'com_contact', 'N', 'n', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(52, 77, 37, 96, 97, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/o', 'com_contact', 'O', 'o', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(53, 78, 37, 98, 99, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/p', 'com_contact', 'P', 'p', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(54, 79, 37, 100, 101, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/q', 'com_contact', 'Q', 'q', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(55, 80, 37, 102, 103, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/r', 'com_contact', 'R', 'r', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(56, 81, 37, 104, 105, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/s', 'com_contact', 'S', 's', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(57, 82, 37, 106, 107, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/t', 'com_contact', 'T', 't', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(58, 83, 37, 108, 109, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/u', 'com_contact', 'U', 'u', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(59, 84, 37, 110, 111, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/v', 'com_contact', 'V', 'v', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(60, 85, 37, 112, 113, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/w', 'com_contact', 'W', 'w', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(61, 86, 37, 114, 115, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/x', 'com_contact', 'X', 'x', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(62, 87, 37, 116, 117, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/y', 'com_contact', 'Y', 'y', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(63, 88, 37, 118, 119, 4, 'sample-data-contact/shop-site/fruit-encyclopedia/z', 'com_contact', 'Z', 'z', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
...
(69, 98, 23, 27, 28, 5, 'sample-data-articles/joomla/extensions/templates/beez3', 'com_content', 'Beez3', 'beez3', '', '<p>Beez3 is a versatile, easy to customise template that works for a variety of sites. It meets major accessibility standards and demonstrates a range of css and javascript techniques.</p><ul><li><a href="index.php?Itemid=424">Home Page</a></li><li><a href="index.php?Itemid=423">Typography</a></li></ul>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 779, '2011-01-01 00:00:01', 123, '2012-09-25 11:47:38', 0, '*', 1),
(72, 108, 28, 42, 43, 4, 'sample-data-articles/park-site/photo-gallery/animals', 'com_content', 'Animals', 'animals', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, 'en-GB', 1),
(73, 109, 28, 44, 45, 4, 'sample-data-articles/park-site/photo-gallery/scenery', 'com_content', 'Scenery', 'scenery', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 779, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, 'en-GB', 1),
...
--
-- Table structure for table `ra2_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `ra2_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ra2_content_frontpage`
--

INSERT INTO `ra2_content_frontpage` (`content_id`, `ordering`) VALUES
(8, 2),
(24, 1),
(35, 4),
(50, 3);
...
--
-- Table structure for table `ra2_content_rating`
--

CREATE TABLE IF NOT EXISTS `ra2_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ra2_content_types`
--

CREATE TABLE IF NOT EXISTS `ra2_content_types` (
...
--
-- Dumping data for table `ra2_content_types`
--

INSERT INTO `ra2_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `ra2_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `ra2_core_log_searches` (
...
--
-- Table structure for table `ra2_extensions`
--

CREATE TABLE IF NOT EXISTS `ra2_extensions` (
...
--
-- Dumping data for table `ra2_extensions`
--

INSERT INTO `ra2_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"49290a280243e279d42bef4c3874a4b2"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `ra2_finder_filters`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_filters` (
...
--
-- Table structure for table `ra2_finder_links`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links` (
...
--
-- Table structure for table `ra2_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ra2_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `ra2_finder_taxonomy`
--

INSERT INTO `ra2_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `ra2_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_finder_terms`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ra2_finder_terms_common`
--

INSERT INTO `ra2_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `ra2_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ra2_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_finder_types`
--

CREATE TABLE IF NOT EXISTS `ra2_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_languages`
--

CREATE TABLE IF NOT EXISTS `ra2_languages` (
...
--
-- Dumping data for table `ra2_languages`
--

INSERT INTO `ra2_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ra2_menu`
--

CREATE TABLE IF NOT EXISTS `ra2_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `ra2_menu`
--

INSERT INTO `ra2_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(444, 'top', 'Sample Sites', 'sample-sites-2', '', 'sample-sites-2', 'index.php?Itemid=', 'alias', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"238","menu-anchor_title":"","menu-anchor_css":"","menu_image":""}', 227, 228, 0, '*', 0),
...
--
-- Table structure for table `ra2_menu_types`
--

CREATE TABLE IF NOT EXISTS `ra2_menu_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `ra2_menu_types`
--

INSERT INTO `ra2_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `ra2_messages`
--

CREATE TABLE IF NOT EXISTS `ra2_messages` (
...
--
-- Table structure for table `ra2_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `ra2_messages_cfg` (
...
--
-- Table structure for table `ra2_modules`
--

CREATE TABLE IF NOT EXISTS `ra2_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `ra2_modules`
--

INSERT INTO `ra2_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(62, 0, 'Language Switcher', '', '', 3, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_languages', 1, 1, '{"header_text":"","footer_text":"","image":"1","layout":"","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
...
(64, 0, 'Language Switcher', '', '', 1, 'languageswitcherload', 779, '2015-11-25 10:48:28', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_languages', 1, 1, '{"header_text":"","footer_text":"","image":"1","layout":"","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
...
--
-- Table structure for table `ra2_modules_menu`
--

CREATE TABLE IF NOT EXISTS `ra2_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ra2_modules_menu`
--

INSERT INTO `ra2_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 101),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `ra2_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `ra2_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `ra2_newsfeeds`
--

INSERT INTO `ra2_newsfeeds` (`catid`, `id`, `name`, `alias`, `link`, `published`, `numarticles`, `cache_time`, `checked_out`, `checked_out_time`, `ordering`, `rtl`, `access`, `language`, `params`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `xreference`, `publish_up`, `publish_down`, `description`, `version`, `hits`, `images`) VALUES
(17, 1, 'Joomla! Announcements', 'joomla-announcements', 'http://feeds.joomla.org/JoomlaAnnouncements', 1, 5, 3600, 0, '0000-00-00 00:00:00', 1, 1, 1, 'en-GB', '{"show_feed_image":"","show_feed_description":"","show_item_description":"","feed_character_count":"0","newsfeed_layout":"","feed_display_order":""}', '2011-01-01 00:00:01', 779, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 1, 0, ''),
(17, 2, 'New Joomla! Extensions', 'new-joomla-extensions', 'http://feeds.joomla.org/JoomlaExtensions', 1, 5, 3600, 0, '0000-00-00 00:00:00', 4, 1, 1, 'en-GB', '{"show_feed_image":"","show_feed_description":"","show_item_description":"","feed_character_count":"0","newsfeed_layout":"","feed_display_order":""}', '2011-01-01 00:00:01', 779, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 1, 0, ''),
(17, 3, 'Joomla! Security News', 'joomla-security-news', 'http://feeds.joomla.org/JoomlaSecurityNews', 1, 5, 3600, 0, '0000-00-00 00:00:00', 2, 1, 1, 'en-GB', '{"show_feed_image":"","show_feed_description":"","show_item_description":"","feed_character_count":"0","newsfeed_layout":"","feed_display_order":""}', '2011-01-01 00:00:01', 779, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 1, 0, ''),
(17, 4, 'Joomla! Connect', 'joomla-connect', 'http://feeds.joomla.org/JoomlaConnect', 1, 5, 3600, 0, '0000-00-00 00:00:00', 3, 1, 1, 'en-GB', '{"show_feed_image":"","show_feed_description":"","show_item_description":"","feed_character_count":"0","newsfeed_layout":"","feed_display_order":""}', '2011-01-01 00:00:01', 779, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '{"robots":"","rights":""}', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `ra2_overrider`
--

CREATE TABLE IF NOT EXISTS `ra2_overrider` (
...
--
-- Table structure for table `ra2_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `ra2_postinstall_messages` (
...
--
-- Dumping data for table `ra2_postinstall_messages`
--

INSERT INTO `ra2_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `ra2_redirect_links`
--

CREATE TABLE IF NOT EXISTS `ra2_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_schemas`
--

CREATE TABLE IF NOT EXISTS `ra2_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ra2_schemas`
--

INSERT INTO `ra2_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Table structure for table `ra2_session`
--

CREATE TABLE IF NOT EXISTS `ra2_session` (
...
--
-- Dumping data for table `ra2_session`
--

INSERT INTO `ra2_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('ob1jcdhe2kt6u5jf3imurtrid2', 1, 0, '1449238429', '__default|a:8:{s:15:"session.counter";i:5;s:19:"session.timer.start";i:1449127359;s:18:"session.timer.last";i:1449128304;s:17:"session.timer.now";i:1449238426;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.3; WOW64; rv:42.0) Gecko/20100101 Firefox/42.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"779";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:24:"guangling.chen@eli-np.ro";s:8:"password";s:60:"$2y$10$xnemCT9KP5xSWHkqdcCAJ.pYZVDhw2uHXZ.7qiqd1vpUhWNYoIzZi";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-11-25 10:45:50";s:13:"lastvisitDate";s:19:"2015-12-02 11:20:46";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"352a510caff3ae5f2b955593e42bfa88";}', 779, 'admin'),
('7to13e22df8a954vdbak71f9b4', 0, 1, '1449238440', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1449238438;s:18:"session.timer.last";i:1449238438;s:17:"session.timer.now";i:1449238438;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.3; WOW64; rv:42.0) Gecko/20100101 Firefox/42.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:2:"13";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:13;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:1:{s:40:"68af800de59b7853798779366d0e397cf058be90";O:8:"stdClass":2:{s:4:"link";s:51:"http://localhost:8080/joomla/index.php/sample-sites";s:6:"expiry";i:1449238439;}}}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `ra2_tags`
--

CREATE TABLE IF NOT EXISTS `ra2_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `ra2_tags`
--

INSERT INTO `ra2_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 779, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `ra2_template_styles`
--

CREATE TABLE IF NOT EXISTS `ra2_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `ra2_template_styles`
--

INSERT INTO `ra2_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `ra2_ucm_base`
--

CREATE TABLE IF NOT EXISTS `ra2_ucm_base` (
...
--
-- Table structure for table `ra2_ucm_content`
--

CREATE TABLE IF NOT EXISTS `ra2_ucm_content` (
...
--
-- Table structure for table `ra2_ucm_history`
--

CREATE TABLE IF NOT EXISTS `ra2_ucm_history` (
...
--
-- Table structure for table `ra2_updates`
--

CREATE TABLE IF NOT EXISTS `ra2_updates` (
...
--
-- Table structure for table `ra2_update_sites`
--

CREATE TABLE IF NOT EXISTS `ra2_update_sites` (
...
--
-- Dumping data for table `ra2_update_sites`
--

INSERT INTO `ra2_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1448448411, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1448448411, ''),
...
--
-- Table structure for table `ra2_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `ra2_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Dumping data for table `ra2_update_sites_extensions`
--

INSERT INTO `ra2_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28),
...
--
-- Table structure for table `ra2_usergroups`
--

CREATE TABLE IF NOT EXISTS `ra2_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `ra2_usergroups`
--

INSERT INTO `ra2_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 22, 'Public'),
(2, 1, 8, 19, 'Registered'),
(3, 2, 9, 16, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `ra2_users`
--

CREATE TABLE IF NOT EXISTS `ra2_users` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `ra2_users`
--

INSERT INTO `ra2_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(779, 'Super User', 'admin', 'guangling.chen@eli-np.ro', '$2y$10$xnemCT9KP5xSWHkqdcCAJ.pYZVDhw2uHXZ.7qiqd1vpUhWNYoIzZi', 0, 1, '2015-11-25 10:45:50', '2015-12-03 07:38:24', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ra2_user_keys`
--

CREATE TABLE IF NOT EXISTS `ra2_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `ra2_user_notes`
--

CREATE TABLE IF NOT EXISTS `ra2_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `ra2_user_profiles`
--

CREATE TABLE IF NOT EXISTS `ra2_user_profiles` (
...
--
-- Table structure for table `ra2_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `ra2_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ra2_user_usergroup_map`
--

INSERT INTO `ra2_user_usergroup_map` (`user_id`, `group_id`) VALUES
(779, 8);

-- --------------------------------------------------------

--
-- Table structure for table `ra2_viewlevels`
--

CREATE TABLE IF NOT EXISTS `ra2_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `ra2_viewlevels`
--

INSERT INTO `ra2_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `ra2_assets`
--
ALTER TABLE `ra2_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_associations`
--
ALTER TABLE `ra2_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `ra2_banners`
--
ALTER TABLE `ra2_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_banner_clients`
--
ALTER TABLE `ra2_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `ra2_banner_tracks`
--
ALTER TABLE `ra2_banner_tracks`
...
--
-- Indexes for table `ra2_categories`
--
ALTER TABLE `ra2_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_contact_details`
--
ALTER TABLE `ra2_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `ra2_content`
--
ALTER TABLE `ra2_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `ra2_contentitem_tag_map`
--
ALTER TABLE `ra2_contentitem_tag_map`
...
--
-- Indexes for table `ra2_content_frontpage`
--
ALTER TABLE `ra2_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `ra2_content_rating`
--
ALTER TABLE `ra2_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `ra2_content_types`
--
ALTER TABLE `ra2_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `ra2_extensions`
--
ALTER TABLE `ra2_extensions`
...
--
-- Indexes for table `ra2_finder_filters`
--
ALTER TABLE `ra2_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `ra2_finder_links`
--
ALTER TABLE `ra2_finder_links`
...
--
-- Indexes for table `ra2_finder_links_terms0`
--
ALTER TABLE `ra2_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms1`
--
ALTER TABLE `ra2_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms2`
--
ALTER TABLE `ra2_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms3`
--
ALTER TABLE `ra2_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms4`
--
ALTER TABLE `ra2_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms5`
--
ALTER TABLE `ra2_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms6`
--
ALTER TABLE `ra2_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms7`
--
ALTER TABLE `ra2_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms8`
--
ALTER TABLE `ra2_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_terms9`
--
ALTER TABLE `ra2_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termsa`
--
ALTER TABLE `ra2_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termsb`
--
ALTER TABLE `ra2_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termsc`
--
ALTER TABLE `ra2_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termsd`
--
ALTER TABLE `ra2_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termse`
--
ALTER TABLE `ra2_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_links_termsf`
--
ALTER TABLE `ra2_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `ra2_finder_taxonomy`
--
ALTER TABLE `ra2_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_finder_taxonomy_map`
--
ALTER TABLE `ra2_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `ra2_finder_terms`
--
ALTER TABLE `ra2_finder_terms`
...
--
-- Indexes for table `ra2_finder_terms_common`
--
ALTER TABLE `ra2_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `ra2_finder_tokens`
--
ALTER TABLE `ra2_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `ra2_finder_tokens_aggregate`
--
ALTER TABLE `ra2_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `ra2_finder_types`
--
ALTER TABLE `ra2_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `ra2_languages`
--
ALTER TABLE `ra2_languages`
...
--
-- Indexes for table `ra2_menu`
--
ALTER TABLE `ra2_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_menu_types`
--
ALTER TABLE `ra2_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `ra2_messages`
--
ALTER TABLE `ra2_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `ra2_messages_cfg`
--
ALTER TABLE `ra2_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `ra2_modules`
--
ALTER TABLE `ra2_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_modules_menu`
--
ALTER TABLE `ra2_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `ra2_newsfeeds`
--
ALTER TABLE `ra2_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `ra2_overrider`
--
ALTER TABLE `ra2_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ra2_postinstall_messages`
--
ALTER TABLE `ra2_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `ra2_redirect_links`
--
ALTER TABLE `ra2_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_link_old` (`old_url`),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `ra2_schemas`
--
ALTER TABLE `ra2_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `ra2_session`
--
ALTER TABLE `ra2_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `ra2_tags`
--
ALTER TABLE `ra2_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_template_styles`
--
ALTER TABLE `ra2_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `ra2_ucm_base`
--
ALTER TABLE `ra2_ucm_base`
...
--
-- Indexes for table `ra2_ucm_content`
--
ALTER TABLE `ra2_ucm_content`
...
--
-- Indexes for table `ra2_ucm_history`
--
ALTER TABLE `ra2_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `ra2_updates`
--
ALTER TABLE `ra2_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `ra2_update_sites`
--
ALTER TABLE `ra2_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `ra2_update_sites_extensions`
--
ALTER TABLE `ra2_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `ra2_usergroups`
--
ALTER TABLE `ra2_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_users`
--
ALTER TABLE `ra2_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_user_keys`
--
ALTER TABLE `ra2_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ra2_user_notes`
--
ALTER TABLE `ra2_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `ra2_user_profiles`
--
ALTER TABLE `ra2_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `ra2_user_usergroup_map`
--
ALTER TABLE `ra2_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `ra2_viewlevels`
--
ALTER TABLE `ra2_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `ra2_assets`
--
ALTER TABLE `ra2_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=179;
--
-- AUTO_INCREMENT for table `ra2_banners`
--
ALTER TABLE `ra2_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `ra2_banner_clients`
--
ALTER TABLE `ra2_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `ra2_categories`
--
ALTER TABLE `ra2_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT for table `ra2_contact_details`
--
ALTER TABLE `ra2_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `ra2_content`
--
ALTER TABLE `ra2_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=71;
--
-- AUTO_INCREMENT for table `ra2_content_types`
--
ALTER TABLE `ra2_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `ra2_extensions`
--
ALTER TABLE `ra2_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10001;
--
-- AUTO_INCREMENT for table `ra2_finder_filters`
--
ALTER TABLE `ra2_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_finder_links`
--
ALTER TABLE `ra2_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_finder_taxonomy`
--
ALTER TABLE `ra2_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ra2_finder_terms`
--
ALTER TABLE `ra2_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_finder_types`
--
ALTER TABLE `ra2_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_languages`
--
ALTER TABLE `ra2_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ra2_menu`
--
ALTER TABLE `ra2_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=473;
--
-- AUTO_INCREMENT for table `ra2_menu_types`
--
ALTER TABLE `ra2_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `ra2_messages`
--
ALTER TABLE `ra2_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_modules`
--
ALTER TABLE `ra2_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=91;
--
-- AUTO_INCREMENT for table `ra2_newsfeeds`
--
ALTER TABLE `ra2_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `ra2_overrider`
--
ALTER TABLE `ra2_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `ra2_postinstall_messages`
--
ALTER TABLE `ra2_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ra2_redirect_links`
--
ALTER TABLE `ra2_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_tags`
--
ALTER TABLE `ra2_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ra2_template_styles`
--
ALTER TABLE `ra2_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `ra2_ucm_content`
--
ALTER TABLE `ra2_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_ucm_history`
--
ALTER TABLE `ra2_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_updates`
--
ALTER TABLE `ra2_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_update_sites`
--
ALTER TABLE `ra2_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `ra2_usergroups`
--
ALTER TABLE `ra2_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `ra2_users`
--
ALTER TABLE `ra2_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=780;
--
-- AUTO_INCREMENT for table `ra2_user_keys`
--
ALTER TABLE `ra2_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_user_notes`
--
ALTER TABLE `ra2_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ra2_viewlevels`
--
ALTER TABLE `ra2_viewlevels`
