...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2015 at 05:39 PM
...
INSERT INTO `ra2db_object` (`Id`, `Name`, `Date_Deliver`, `Date_Test`, `Price`, `Series_No`, `Location`, `Note`, `visible`, `timestamp`) VALUES
(1, 'Statie cu monitor Dell', '2014-12-18', '2014-12-18', 4469, 'Desktop: GLBGJ32; Monitor: CN0J8J317444546BAL6B', '1', '', 1, '2015-09-01 13:43:40'),
(2, 'Test object 1', '2015-09-25', '2015-09-26', 3500, '0002228555adsfsdg4444', 'ELI-NP Bloc Turn / Camera 303', 'for test', 1, '2015-09-28 08:52:05');
...
CREATE TABLE IF NOT EXISTS `ra2db_object_modify` (
  ...
  `Id_People_Modified` int(11) NOT NULL,
