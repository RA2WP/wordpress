...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2015 at 01:44 PM
...
(3, 'ELI-NP Bloc Turn', 'Camera 301', 'ELI-NP Bloc Turn / Camera 301', '', 1, '2015-11-18 09:43:42');
...
INSERT INTO `ra2db_object` (`Id`, `Name`, `Purchase_No`, `Date_Deliver`, `Date_Test`, `Price`, `Series_No`, `Location`, `Note`, `visible`, `timestamp`) VALUES
(1, 'Statie cu monitor Dell', '8399500', '2014-12-18', '2014-12-18', 4469, 'Desktop: GLBGJ32; Monitor: CN0J8J317444546BAL6B', 'ELI-NP Bloc Turn  / Camera 503A', '', 1, '2015-09-01 13:43:40'),
(2, 'Test object 1', '8399501', '2015-09-25', '2015-09-26', 3500, '0002228555adsfsdg4444', 'ELI-NP Bloc Turn / Camera 303', 'for test', 1, '2015-09-28 08:52:05');
...
(1, 'Test object 1', 'ELI-NP Bloc Turn  / Camera 503A', 'Test People', '2015-09-30 21:00:00', 'test', 1, '2015-10-01 15:21:27'),
(2, 'Statie cu monitor Dell', 'ELI-NP Bloc Turn  / Camera 503A', 'Test People2', '2015-10-01 21:00:00', 'Test modify function', 1, '2015-10-02 08:32:10'),
(3, 'Statie cu monitor Dell', 'ELI-NP Bloc Turn / Camera 303', 'Test People5', '2015-10-01 21:00:00', 'Test modify function move to 303', 1, '2015-10-02 08:32:58'),
(4, 'Statie cu monitor Dell', 'ELI-NP Bloc Turn  / Camera 503A', 'admin', '2015-10-01 21:00:00', '', 1, '2015-10-02 11:07:09'),
(5, 'Test object 1', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-10-02 21:00:00', '', 1, '2015-10-02 11:08:19'),
(6, 'Test object 1', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-10-14 14:02:33', '', 1, '2015-10-14 14:02:33'),
(7, 'Test object 1', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-10-14 14:07:33', '', 1, '2015-10-14 14:07:33'),
(8, 'Test object 1', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-10-14 14:10:26', '', 1, '2015-10-14 14:10:26'),
(9, 'Test object 1', 'ELI-NP Bloc Turn  / Camera 503A', 'admin', '2015-10-14 14:11:07', '', 1, '2015-10-14 14:11:07'),
(10, 'Statie cu monitor Dell', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-10-19 10:13:46', 'ghjghkhg', 1, '2015-10-19 10:13:46'),
(11, 'Test object 1', 'ELI-NP Bloc Turn / Camera 303', 'admin', '2015-11-04 14:03:53', '', 1, '2015-11-04 14:03:53'),
(12, 'Statie cu monitor Dell', 'ELI-NP Bloc Turn  / Camera 503A', 'admin', '2015-11-10 14:08:35', 'some test test test ', 1, '2015-11-10 14:08:35'),
(13, 'Test object 1', 'ELI-NP Bloc Turn / Camera 301', 'admin', '2015-11-23 08:52:10', '', 1, '2015-11-23 08:52:10');
...
(18, 'value1', '123', '87878787', 'test.people6@eli-np.ro', '87878787', 1, '2015-12-02 14:33:41');
...
INSERT INTO `ra2db_purchase` (`Id`, `Number`, `Id_People_Responsible1`, `Id_People_Responsible2`, `Id_Financial`, `Note`, `visible`, `timestamp`) VALUES
(1, '8399500', 2, 3, 1, '', 1, '2015-09-01 14:34:11'),
(2, '8399501', 4, 5, 2, 'test', 1, '2015-10-15 11:14:48');
...
--
-- Table structure for table `ra2db_test`
--

CREATE TABLE IF NOT EXISTS `ra2db_test` (
...
--
-- Dumping data for table `ra2db_test`
--

INSERT INTO `ra2db_test` (`ID`, `Name`, `Number`) VALUES
(1, 'someth', ''),
(6, 'Name1', '123654789855'),
(7, 'Name1', '123654789855'),
(8, 'Name1', '123654789855'),
(9, 'Name1', '123654789855');
...
(1, 'admin2', 'e10adc3949ba59abbe56e057f20f883e', 'admin2@email.com', 1, '2015-11-24 13:13:19'),
(2, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'admin@email.com', 1, '2015-11-24 13:38:01');
...
--
-- Indexes for table `ra2db_test`
--
ALTER TABLE `ra2db_test`
  ADD PRIMARY KEY (`ID`);
...
ALTER TABLE `ra2db_supplier`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ra2db_test`
--
ALTER TABLE `ra2db_test`
  MODIFY `ID` tinyint(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `ra2db_user`
--
ALTER TABLE `ra2db_user`
  MODIFY `uid` mediumint(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
