...
<?php
  ...
  // <![CDATA[
    ...
    jQuery('#devfmt_langselector').remove();
    ...
    DevFmt_ShowSelector = function(){
      ...
      tb_show('DevFormatter','?TB_inline=1&modal=false&inlineId=devfmt_langselector', null);
    ...
    DevFmt_SelectLang = function(){
      ...
      if(HtmlEditor){
        tinyMCE.activeEditor.execCommand('mceReplaceContent', false,
          window.wp.editor.autop(DevFmt_ContentStart + DevFmt_TheContent + DevFmt_ContentEnd));
      }else{
