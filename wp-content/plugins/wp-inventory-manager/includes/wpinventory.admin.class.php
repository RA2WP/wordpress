...
final class WPIMAdmin extends WPIMCore {
	...
	public static function instructions() {
		...
		echo '<ol>';
		echo '<li>' . self::__( 'Set up your' ) . ' <a href="admin.php?page=manage_categories">' . self::__( 'Inventory Categories' ) . '</a></li>' . PHP_EOL;
		echo '<li>' . self::__( 'Configure the' ) . ' <a href="admin.php?page=manage_settings">' . self::__( 'Settings' ) . '</a></li>' . PHP_EOL;
		echo '<li>' . self::__( 'Configure labels' ) . ' <a href="admin.php?page=manage_labels">' . self::__( 'Labels' ) . '</a></li>' . PHP_EOL;
		echo '<li>' . self::__( 'Set Display Options' ) . ' <a href="admin.php?page=manage_display">' . self::__( 'Display' ) . '</a></li>' . PHP_EOL;
		echo '<li>' . self::__( 'Then, you can ' ) . '<a href="admin.php?page=manage_inventory_items">' . self::__( 'Add Inventory Items' ) . '</a></li>' . PHP_EOL;
			...
			<table class="form-table">
				...
				if ( self::label_is_on( 'inventory_price' ) ) { ?>
					<tr>
						...
						<td><input name="inventory_price" class="small-text"
