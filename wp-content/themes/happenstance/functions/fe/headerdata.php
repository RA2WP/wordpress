...
// Google Fonts
$bodyfont = get_theme_mod('happenstance_body_google_fonts', $happenstance_defaults['happenstance_body_google_fonts']);
$headingfont = get_theme_mod('happenstance_headings_google_fonts', $happenstance_defaults['happenstance_headings_google_fonts']);
$descriptionfont = get_theme_mod('happenstance_description_google_fonts', $happenstance_defaults['happenstance_description_google_fonts']);
$headlinefont = get_theme_mod('happenstance_headline_google_fonts', $happenstance_defaults['happenstance_headline_google_fonts']);
$postentryfont = get_theme_mod('happenstance_postentry_google_fonts', $happenstance_defaults['happenstance_postentry_google_fonts']);
$sidebarfont = get_theme_mod('happenstance_sidebar_google_fonts', $happenstance_defaults['happenstance_sidebar_google_fonts']);
$menufont = get_theme_mod('happenstance_menu_google_fonts', $happenstance_defaults['happenstance_menu_google_fonts']);
...
function happenstance_styles_method() {
  global $happenstance_defaults;
	wp_enqueue_style( 'happenstance-style', get_stylesheet_uri() );
        ...
        $layout_style = get_theme_mod('happenstance_layout', $happenstance_defaults['happenstance_layout']);
        $background_pattern_opacity = get_theme_mod('happenstance_background_pattern_opacity', $happenstance_defaults['happenstance_background_pattern_opacity']);
        $display_main_shadow = get_theme_mod('happenstance_display_main_shadow', $happenstance_defaults['happenstance_display_main_shadow']);
        $display_sidebar = get_theme_mod('happenstance_display_sidebar', $happenstance_defaults['happenstance_display_sidebar']);
        $display_sidebar_archives = get_theme_mod('happenstance_display_sidebar_archives', $happenstance_defaults['happenstance_display_sidebar_archives']);
        $display_search_form = get_theme_mod('happenstance_display_search_form', $happenstance_defaults['happenstance_display_search_form']);
        $display_meta_post_entry = get_theme_mod('happenstance_display_meta_post_entry', $happenstance_defaults['happenstance_display_meta_post_entry']);
        $bodyfont = get_theme_mod('happenstance_body_google_fonts', $happenstance_defaults['happenstance_body_google_fonts']);
        $headingfont = get_theme_mod('happenstance_headings_google_fonts', $happenstance_defaults['happenstance_headings_google_fonts']);
        $descriptionfont = get_theme_mod('happenstance_description_google_fonts', $happenstance_defaults['happenstance_description_google_fonts']);
        $headlinefont = get_theme_mod('happenstance_headline_google_fonts', $happenstance_defaults['happenstance_headline_google_fonts']);
        ...
        $sidebarfont = get_theme_mod('happenstance_sidebar_google_fonts', $happenstance_defaults['happenstance_sidebar_google_fonts']);
        $menufont = get_theme_mod('happenstance_menu_google_fonts', $happenstance_defaults['happenstance_menu_google_fonts']);
        $own_css = get_theme_mod('happenstance_own_css', $happenstance_defaults['happenstance_own_css']); 
