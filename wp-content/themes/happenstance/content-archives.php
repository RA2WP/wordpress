...
<?php } ?>
<?php if ( get_theme_mod('happenstance_display_meta_post_entry', $happenstance_defaults['happenstance_display_meta_post_entry']) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php if ( get_theme_mod('happenstance_content_archives', $happenstance_defaults['happenstance_content_archives']) != 'Content' ) { ?>
<?php the_excerpt(); ?>
<?php } else { ?>
...
<?php if ( get_theme_mod('happenstance_display_meta_post_entry', $happenstance_defaults['happenstance_display_meta_post_entry']) != 'Hide' && has_category() ) { ?>
        <div class="post-info">
