...
<div id="comments" class="comments-area<?php if ( get_theme_mod('happenstance_next_preview_post', $happenstance_defaults['happenstance_next_preview_post']) == 'Display' || get_theme_mod('happenstance_next_preview_post', $happenstance_defaults['happenstance_next_preview_post']) == '' ) { ?> comments-area-post<?php } ?>">
