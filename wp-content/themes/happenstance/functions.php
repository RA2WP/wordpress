...
/**
 * HappenStance theme specific functions and customizer.
 *  
*/    
// Set path to HappenStance theme specific functions
$happenstance_fe_path = get_template_directory() . '/functions/fe/'; 
// Include Theme specific functionality [FE]  
require_once ($happenstance_fe_path . 'headerdata.php');
require_once ($happenstance_fe_path . 'library.php');
// Include Theme Customization admin screen  
require_once (get_template_directory() . '/functions/customizer.php');
// Include About HappenStance admin page 
...
function happenstance_scripts_styles() {
	global $wp_styles, $wp_scripts, $happenstance_defaults;
	// Adds JavaScript
	  if ( is_singular() && comments_open() && get_option( 'thread_comments' ) )
		wp_enqueue_script( 'comment-reply' );
    if ( get_theme_mod('happenstance_post_entry_format', $happenstance_defaults['happenstance_post_entry_format']) == 'Grid - Masonry' ) {
    ...
    if ( get_theme_mod('happenstance_display_scroll_top', $happenstance_defaults['happenstance_display_scroll_top']) != 'Hide' ) {
...
if (get_theme_mod('happenstance_excerpt_length', $happenstance_defaults['happenstance_excerpt_length']) != '') {
return get_theme_mod('happenstance_excerpt_length', $happenstance_defaults['happenstance_excerpt_length']);
} else { return 40; }
}
