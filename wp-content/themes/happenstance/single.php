...
<?php if ( get_theme_mod('happenstance_display_meta_post', $happenstance_defaults['happenstance_display_meta_post']) != 'Hide' ) { ?>
    <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( get_theme_mod('happenstance_next_preview_post', $happenstance_defaults['happenstance_next_preview_post']) != 'Hide' ) { ?>
