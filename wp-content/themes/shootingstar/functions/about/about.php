...
array( "name" => "tab_content_1",
  ...
  array( "type" => "infotext",
		"name" => __( 'If you would like to purchase the ShootingStar Premium Version, you can do so on <a href="http://www.tomastoman.cz/downloads/shootingstar/" target="_blank">Developers Official Website</a>.' , 'shootingstar' )),
...
?>
	...
	<div id="wrap_fm"><!-- [ Header ]-->
		...
		<div class="top_menu_fm">
			<a target="_blank" class="doc_fm" href="<?php echo esc_url($shootingstar_manualurl); ?>"><?php _e( 'Documentation' , 'shootingstar' ); ?></a><a target="_blank" class="support_fm" href="http://www.tomastoman.cz/support"><?php _e( 'Support' , 'shootingstar' ); ?></a><a target="_blank" class="premium_fm" href="http://www.tomastoman.cz/downloads/shootingstar/"><?php _e( 'Get Premium Version' , 'shootingstar' ); ?></a>
		</div>
